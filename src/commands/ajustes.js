    ...
    if (sub === 'ver') {
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          { name: 'Prefijo al reclamar', value: config?.claimed_prefix || 'reclamado', inline: true },
      ...
      modal.addComponents(
        ...
        new ActionRowBuilder().addComponents(
          new TextInputBuilder()
            ...
            .setLabel('Prefijo del canal al reclamar')
            .setStyle(TextInputStyle.Short)
            .setValue(config?.claimed_prefix || 'reclamado')
            .setRequired(true)
        ),
        new ActionRowBuilder().addComponents(
          new TextInputBuilder()
